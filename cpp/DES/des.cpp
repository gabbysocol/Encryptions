...
{
    // Получаем перестановку для "Расписания ключей"
    ui64 permuted_choice_1 = 0; // 56 бит
    for (ui8 i = 0; i < 56; i++)
    {
        permuted_choice_1 <<= 1;
...
ui32 DES::f(ui32 R, ui64 k)
{
    ...
    // Обратная сжимающая перестановка
    ui32 s_output = 0;
    for (ui8 i = 0; i < 8; i++)
    {
